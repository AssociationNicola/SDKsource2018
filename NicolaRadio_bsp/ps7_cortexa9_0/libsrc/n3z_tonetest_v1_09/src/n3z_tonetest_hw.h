...
#define N3Z_TONETEST_STARTTONEAMP 0x10/**< starttoneamp */
#define N3Z_TONETEST_DEMODSIGNALLEVEL 0x14/**< demodsignallevel */
#define N3Z_TONETEST_TXAUDIOLEVEL 0x18/**< txaudiolevel */
